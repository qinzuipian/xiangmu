           ...
           <!--  <el-row>
            ...
            <div class="upload" v-show="userType == 2">
                <el-upload
                        class="upload-demo"
                        ref="upload"     
                        action="http://172.16.178.13:8089/zuul/outpatient/biz/rstdatreply/batchupload"
...
export default {
  name: "reply",
  props: ["copystatusmsg", "childMsgData", "presId", "userType"],
  data() {
    return {
      defaultMsg: "",
      config: {
  ...
  methods: {
    ...
    getEnclosure() {
      ...
      // 讲改项的presId赋值给参数
      this.uploaddata.presId = this.presId;
    ...
    handleRemove(file, fileList) {
      axios({
        method: "post",
        url:
          axios.PARK_API + "/zuul/outpatient/biz/rstdatreply/deletefile",
        params: {
          presId: this.presId,
