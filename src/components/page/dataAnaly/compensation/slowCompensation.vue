   ...
   <div>
      <div class="right-ctn-title">
           ...
           <span v-show="slow">
            ...
            <el-button size="mini" type="warning" style="margin-left: 5px;" @click="getSlow">
...
export default {
  ...
  methods: {
    getname() {
      localStorage.setItem("hometext", "【慢病补偿情况分析（地区 ）】");
    ...
    getSlow() {
      ...
      axios({
        method: "post",
        // url: axios.PARK_API + "/backstage/loadPicData_manbing",
        url: axios.PARK_API + "/xnhidc/backstage/loadPicData_manbing",
        data: qs.stringify({
        ...
        if (res.data.success) {
          ...
          for (var i = 0; i < echarts_date.length; i++) {
            ...
            datazyzrenshu[i] = echarts_date[i].慢病总人数;
