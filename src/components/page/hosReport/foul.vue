...
export default {
  ...
  methods: {
    ...
    //页面初始化时请求页面数据
    getFoul() {
      localStorage.setItem("hometext", "【住院-违规统计】");
      axios({
        method: "post",
        url:
          axios.PARK_API + "/hospitalization/biz/analy/queryruleviolationanaly",
        /*  params: {
          message: "疑似重复收取诊察费"
        } */
        data: {
    ...
    ruleFocus() {
      ...
      axios({
        method: "post",
        url:
          axios.PARK_API + "/hospitalization/biz/rstdatordermsg/listMsgmessage",
        params: {
