<template>
    <div>
        <div class="right-ctn-title">
            ...
            <el-button size="mini" type="primary"  @click="queryClear">重置</el-button>
...
export default {
  ...
  methods: {
    ...
    //页面初始化请求数据
    getQuery() {
      localStorage.setItem("hometext", "【门诊-审核结果分析】");
      axios({
        method: "post",
        url: axios.PARK_API + "/outpatient/biz/analy/queryresultanaly",
        params: {
