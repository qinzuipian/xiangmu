...
export default {
  ...
  methods: {
    ...
    topChart() {
        localStorage.setItem("hometext", "【门诊-违规趋势分析】");
      ...
      axios({
        method: "post",
        url:
          axios.PARK_API + "/outpatient/biz/analy/queryIrreCaseTimeanaly",
        /*  params: {
          regionName: "西安市鄠邑区"
        } */
        data: {
    ...
    topTog() {
      ...
      axios({
        method: "post",
        url: axios.PARK_API + "/outpatient/biz/analy/queryIrreTrendanaly",
        /*  params: {
          regionName: "西安市鄠邑区"
        } */
        data: {
    ...
    botTog() {
      ...
      axios({
        method: "post",
        url:
          axios.PARK_API + "/outpatient/biz/analy/queryIrreTrendTimeanaly",
        /*  params: {
          regionName: "西安市鄠邑区"
        } */
        data: {
